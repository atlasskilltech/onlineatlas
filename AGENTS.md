...
after header now we move forward to first section herobanner "public\reference-design\hero-banner.png" first look this carefully and analysis perfectly then use asset for this from here 
"public\herobanner" make it similar perfectly like "public\reference-design\hero-banner.png" responsive for all device perfectly
...
C:\mern\github\faizan\onlineatlas\public\ninetheen-section\brand-logo
now on programs start making fourth section design reference from this folder "public\reference-design\programs\4.png" and take assets from this "public" folder and dont make new desing stick with the main page desing and also there is many chance to use usable component from main page so always try to use usable component with out any issue on tha main page okay only responsive for all device perfectly
...
now on programs start making sixth section design reference from this folder "public\reference-design\programs\6.png" and take assets from this "public" folder and dont make new desing stick with the main page desing and also there is many chance to use usable component from main page so always try to use usable component with out any issue on tha main page okay only responsive for all device perfectly
...
now on programs start making seventh section design reference from this folder "public\reference-design\programs\7.png" and take assets from this "public" folder and dont make new desing stick with the main page desing and also there is many chance to use usable component from main page so always try to use usable component with out any issue on tha main page okay only responsive for all device perfectly
...
now on programs start making eigth section design reference from this folder "public\reference-design\programs\8.png" and take assets from this "public" folder and dont make new desing stick with the main page desing and also there is many chance to use usable component from main page so always try to use usable component with out any issue on tha main page okay only responsive for all device perfectly
