...
function ProfileCard() {
  return (
    <div className="mx-auto w-full max-w-sm rounded-[26px] bg-[#f6f7ee]  shadow-xl shadow-black/15 lg:mx-0 lg:w-[360px] lg:shrink-0">
      <div className="relative aspect-[339/336] w-full overflow-hidden rounded-[20px]">
        {/* Featured profile photo (already framed in the asset). */}
        <Image
        ...
        <div className="absolute inset-x-3 bottom-3 flex items-stretch rounded-xl bg-[#081f3d] px-3.5 py-3 shadow-lg shadow-black/30 sm:inset-x-4 sm:bottom-4">
  ...
  return (
    <section className="relative overflow-hidden bg-atlas-lime">
      {/* Decorative four-point star — the asset is a semi-transparent navy that
          composites over the lime into the reference's olive tone. It bleeds off
          the right edge and is purely cosmetic, so it's hidden on small screens. */}
      <div
        aria-hidden="true"
        className="pointer-events-none absolute right-0 top-1/2 hidden -translate-y-1/2 translate-x-[0%] lg:block"
      >
        <Image
          src="/fiveth-section/shape/vector.png"
          alt=""
          width={176}
          height={278}
        ...
        <div className="flex flex-col gap-10 lg:flex-row lg:items-center lg:gap-14">
          ...
          <div className="flex-1">
            ...
            <p className="mt-4 max-w-xl text-base leading-relaxed text-[#081f3d]/80 sm:text-lg">
              Join a new generation of business professionals equipped to
              navigate change, leverage AI, and create impact.
            </p>
            ...
            <ul className="mt-6 flex flex-wrap gap-x-7 gap-y-3">
              {FEATURES.map((feature) => (
                <li key={feature} className="flex items-center gap-2">
                  <Image
                    src="/fiveth-section/icon/right.png"
                    alt=""
                    aria-hidden="true"
                    width={26}
                    height={26}
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
              <Link
                href="#apply"
                className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-[#081f3d] px-7 py-3.5 text-sm font-bold text-white transition-colors hover:bg-[#0d2c54] sm:w-auto sm:text-base"
              >
                Apply Now
                <ArrowRight />
              </Link>
              <Link
                href="#prospectus"
                className="inline-flex w-full items-center justify-center gap-2 rounded-xl border border-[#081f3d]/50 px-7 py-3.5 text-sm font-bold text-[#081f3d] transition-colors hover:bg-[#081f3d]/5 sm:w-auto sm:text-base"
              >
                Prospectus
                <ArrowRight />
              </Link>
